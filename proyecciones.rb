...
res_sim = []    #Resultados de simulaciones
...
2.times do |i|
    ...
    #                              simulacion(datos, aumento, ini, fin)
    #Simulacion 1: cuando  i=0  -> simulacion( data,     1.1,   0,   5)
    #Simulacion 2: cuando  i=1  -> simulacion( data,     1.2,   6,  11)
